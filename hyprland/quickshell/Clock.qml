...
PanelWindow {
    ...
    SequentialAnimation {
        ...
        PropertyAnimation { target: card; property: "color"; to: "#c0101010"; duration: 250 }
    }
        ...
        ColumnLayout {
                ...
                Row {
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            text: "Timer"
                            color: root.mode === 0 ? "#f0f0f0" : "#55ffffff"
                            font.pixelSize: 13
                    ...
                    Item {
                        ...
                        Text {
                            anchors.centerIn: parent
                            text: "Stopwatch"
                            color: root.mode === 1 ? "#f0f0f0" : "#55ffffff"
                            font.pixelSize: 13
                            font.weight: Font.Medium
                            Behavior on color { ColorAnimation { duration: 150 } }
                        }
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    height: 34
                    radius: 12
                    color: playMouse.containsPress ? "#55ffffff" : "#35ffffff"
                    border.width: 1
                    border.color: "#20ffffff"
                ...
                Rectangle {
                    ...
                    height: 34
                    radius: 12
                    color: resetMouse.containsPress ? "#44221111" : "#28ffffff"
                    border.width: 1
                    border.color: "#20ffffff"
                    Behavior on color { ColorAnimation { duration: 100 } }
    ...
    component SpinnerField: Item {
        ...
        Column {
            ...
            Rectangle {
                ...
                height: 26
                radius: 6
                color: inputField.activeFocus ? "#30ffffff" : "transparent"
